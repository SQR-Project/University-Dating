...
from src.models.like import LikeProfileRequest
from src.services import like_service, auth_service
...
def app():
    ...
    def render_like():
        ...
        if session_state % 2 == 1:# like_service.is_matched(token_data, like_profile_request):
